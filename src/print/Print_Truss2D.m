...
% implementation of the *2D Truss* print object.
%
classdef Print_Truss2D < Print
    %% Constructor method
    methods
        %------------------------------------------------------------------
        function print = Print_Truss2D(model)
            print = print@Print(1);
    ...
    methods
        ...
        function section(print)
            ...
            if print.model.nsec > 0
                fprintf(print.txt, ' SECTION     AREA [cm²]      HEIGHT [cm]\n');

                for s = 1:print.model.nsec
                    fprintf(print.txt, '%4d   %14.2f   %13.2f\n', s,...
        ...
        function nodalSupport(print)
            ...
            fprintf(print.txt, '------------------------------\n');
            fprintf(print.txt, ' NODE   DISPL X    DISPL Y   |   INCL.SUPP    ROT Z [°]    Vx_x     Vx_y\n');
            ...
            for n = 1:print.model.nnp
                ...
                fprintf(print.txt, '%4d     %6s     %6s   |   %9s    %7s     %5s    %5s\n', n,...
                        node_restr1,...
                        node_restr2,...
                        incl,...
                        rot,...
        ...
        function spring(print,n_ns)
            ...
            if n_ns ~= 0
                fprintf(print.txt, ' NODE     KDX [kN/m]      KDY [kN/m]\n');

                for n = 1:print.model.nnp
                    if ~isempty(print.model.nodes(n).springStiff)
                        fprintf(print.txt, '%4d   %13.3e   %13.3e\n', n,...
        ...
        function nodalLoads(print,n_nl)
            ...
            if n_nl ~= 0
                aux = 0;
                fprintf(print.txt, ' NODE     FX [kN]          FY [kN]\n');
                for n = 1:print.model.nnp
                    if ~isempty(print.model.nodes(n).load.static) && ~all(print.model.nodes(n).load.static == 0)
                        fprintf(print.txt, '%4d   %10.3f   %14.3f\n', n,...
        ...
        function nodalPrescDisp(print,n_pd)
            ...
            if n_pd ~= 0
                aux = 0;
                fprintf(print.txt, ' NODE     DX [mm]          DY [mm]\n');
                for n = 1:print.model.nnp
                    if ~isempty(print.model.nodes(n).prescDispl) && ~all(print.model.nodes(n).prescDispl == 0)
                        fprintf(print.txt, '%4d   %8.1f   %14.1f\n', n,...
        ...
        function nodalDisplRot(print)
            ...
            fprintf(print.txt, '---------------------------------------------------------\n');
            fprintf(print.txt, ' NODE      DISPL X [mm]       DISPL Y [mm]\n');
            ...
            for n = 1:print.model.nnp
                ...
                fprintf(print.txt, '%4d     %11.2e     %14.2e\n', n, dx, dy);
            end
        end
        ...
        function reactions(print)
            ...
            fprintf(print.txt, '---------------------------------\n');
            fprintf(print.txt, ' NODE       FORCE X [kN]     FORCE Y [kN]\n');
            ...
            for n = 1:print.model.nnp
                if( (print.model.ID(1,n) > print.model.neqfree) || ...
                    ...
                    fprintf(print.txt, '%4d     %13.3f   %14.3f\n', n, ...
                            node_reaction1, node_reaction2);
                end
            end
        end
